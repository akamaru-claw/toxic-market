...
- **CSRF**: Alle schreibenden API-Endpunkte fordern einen `X-CSRF-Token`-Header aus der Session. Die HTML-Formulare auf `create.php` und `create-auction.php` senden das Token ebenfalls.
